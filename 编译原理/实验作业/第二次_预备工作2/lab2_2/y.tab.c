...
static const char *const yytname[] =
{
  ...
  "multiply", "divide", "leftp", "rightp", "NUMBER", "ID", "equal",
  "UMINUS", "';'", "$accept", "lines", "expr", "expr2", YY_NULLPTR
};
...
{
       5,     0,     1,     0,     0,    13,    12,     4,     0,     0,
      12,    11,     0,     0,     0,     0,     0,     0,     2,     3,
      10,    14,     6,     7,     8,     9
};
...
#line 1217 "y.tab.c"
  ...
  case 12: /* expr: ID  */
#line 77 "expr4.y"
                        {yyval.num=lookup_symbol(yyvsp[0].str);yyval.str=(char*)malloc(100);strcpy(yyval.str,yyvsp[0].str);}
#line 1223 "y.tab.c"
    break;
...
#line 1229 "y.tab.c"
  ...
  case 14: /* expr2: ID equal expr  */
#line 81 "expr4.y"
                                {yyval.num=yyvsp[0].num;yyval.str=(char*)malloc(100);strcpy(yyval.str,yyvsp[-2].str);strcat(yyval.str,"被赋值");insert_symbol(yyvsp[-2].str,yyval.num);}
#line 1235 "y.tab.c"
    break;
